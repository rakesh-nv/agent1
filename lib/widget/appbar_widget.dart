                  ...
                  Text(
                    ...
                    style: AppStyle.headTextStyle().copyWith(
                      ...
                      fontSize: SizeConfig.w(
                        AppStyle.headFontSize * (isLandscape ? 0.7 : 0.8),
                      ).clamp(17, 20), // Clamped for landscape
                    ),
                    maxLines: 1,
                  ...
                  if (reportingTo != null && reportingTo!.isNotEmpty)
                    Text(
                      ...
                      style: AppStyle.normalTextStyle().copyWith(
                        color: AppStyle.appBarTextColor,
                        fontSize: SizeConfig.w(
                          AppStyle.normalFontSize * (isLandscape ? 0.6 : 0.7),
                        ).clamp(10, 14), // Clamped for landscape
