...
class SalesByPhaseApiService {
  final String apiUrl =
      "https://reports-mb-dev-backend.cstechns.com/api/mobile/sales-by-phase";

  Future<SalesByPhaseResponse> fetchSalesByPhase() async {
    try {
      ...
      debugPrint("--------Current Phase Response----------:: ${response.body}");
      ...
      if (response.statusCode == 200) {
        ...
        return SalesByPhaseResponse.fromJson(jsonData);
