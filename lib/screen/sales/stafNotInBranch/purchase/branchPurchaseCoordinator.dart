...
class BranchPurchaseCoordinatorScreen extends StatefulWidget {
  const BranchPurchaseCoordinatorScreen({super.key});

  @override
  State<BranchPurchaseCoordinatorScreen> createState() =>
      _BranchPurchaseCoordinatorScreenState();
}

class _BranchPurchaseCoordinatorScreenState
    extends State<BranchPurchaseCoordinatorScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              "Overview of branch purchase activities and metrics",
              style: TextStyle(
                fontSize: SizeConfig.w(14),
